  ...
  return (
    <section id="about" className="py-24 bg-teal-50/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-24 border-t border-teal-150/40 mt-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
            ...
            >
              <div className="aspect-[4/3] w-full overflow-hidden relative">
                ...
                />
                <span className="absolute top-4 left-4 bg-primary text-white text-[10px] font-black uppercase px-2.5 py-1 rounded-full shadow-sm z-10">
                  Operative Care Zone
                </span>
              </div>
              <div className="p-6 text-left">
                <h4 className="font-extrabold text-lg text-foreground mb-1">State-of-the-Art Operations Room</h4>
            ...
            >
              <div className="aspect-[4/3] w-full overflow-hidden relative">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <span className="absolute top-4 left-4 bg-teal-600 text-white text-[10px] font-black uppercase px-2.5 py-1 rounded-full shadow-sm z-10">
                  Pediatric Success
                </span>
              </div>
              <div className="p-6 text-left">
                <h4 className="font-extrabold text-lg text-foreground mb-1">Painless Pediatric Checkups</h4>
                <p className="text-xs text-muted-foreground leading-relaxed font-semibold">
            ...
            >
              <div className="aspect-[3/4] w-full overflow-hidden relative">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <span className="absolute top-4 left-4 bg-amber-600 text-white text-[10px] font-black uppercase px-2.5 py-1 rounded-full shadow-sm z-10">
                  Prosthetic Tech
                </span>
              </div>
              <div className="p-6 text-left">
            ...
            >
              <div className="aspect-[3/4] w-full overflow-hidden relative">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <span className="absolute top-4 left-4 bg-blue-600 text-white text-[10px] font-black uppercase px-2.5 py-1 rounded-full shadow-sm z-10">
                  Patient Counsel
                </span>
              </div>
              <div className="p-6 text-left">
